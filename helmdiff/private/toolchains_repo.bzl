...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@slamdev_rules_helmdiff//helmdiff:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.helmdiffinfo,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@slamdev_rules_helmdiff//helmdiff:toolchain_type"],
...
# By default all these toolchains are registered by the helmdiff_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:helmdiff_toolchain",
    toolchain_type = "@slamdev_rules_helmdiff//helmdiff:toolchain_type",
)
""".format(
            platform = platform,
